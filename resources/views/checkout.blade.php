...
<x-ht-layout>
    <div class="body d-flex justify-content-center">
            ...
            <div class="w-full">
                <div class="w-full">
                    <form action="{{ route('complete-order') }}" method="post">
                        ...
                        <input type="hidden" class="w-full" name="quantity[]" value="{{$order['quantity']}}">
                        
                        @endforeach

                        <div class="mt-4">
                            <label for="" class="w-full">Names</label>
                            <input type="text" name="names" class="rounded w-full" value="{{ old('names') }}" placeholder="Enter your names">
                        ...
                        <div class="mt-4">
                            <div class="flex-section gap-3">
                                <div>
                                    ...
                                    <input type="email" name="email" class="rounded w-full" value="{{ old('email') }}" placeholder="Enter your email address">
                                    <x-input-error :messages="$errors->get('email')" class="mt-2" />
                                </div>

                                <div>
                                    <label for="" class="w-full">Phone number</label>
                                    <input type="text" name="phone" class="rounded w-full" value="{{ old('phone') }}" placeholder="Enter your email phone number">
                        ...
                        <div class="mt-3" id="delivery_address">
                            ...
                            <div class="d-flex gap-2">
                                <input class="w-full" type="text" name="city" value="{{ old('city') }}" placeholder="City/District">
                                <input class="w-full" type="text" name="sector" value="{{ old('sector') }}" placeholder="Sector">
                                <input class="w-full" type="text" name="cell" value="{{ old('cell') }}" placeholder="Cell">
                                <input class="w-full" type="text" name="village" value="{{ old('village') }}" placeholder="Village">
                            </div>

                            <textarea name="address_details" id="" rows="1" class="w-full rounded mt-2" placeholder="Describe your neighbourhood">{{ old('address_details') }}</textarea>
                        </div>
        ...
        <input id="phone" class="block mt-1 w-full" type="text" name="phone_number" :value="old('phone_number')" placeholder="Phone number" autocomplete="phone" />
