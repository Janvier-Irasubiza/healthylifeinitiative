@section('title', 'Edit category info')
...
<div class="col-lg-7 p-2 mt-3 mb-5">
    ...
    <div class="w-full">
        <div class="w-full">
            <form action="{{ route('admin.edit-category-info') }}" method="post" enctype="multipart/form-data"> @csrf
                <h2 class="form-title-sub">Edit category info</h2>
                <div class="mt-4 w-full">
                    <label for="" class="w-full fw-500">Category name</label>
                    <input class="w-full mt-2" type="hidden" id="productName" name="id" value="{{ $category->id }}" placeholder="Enter product name" autofocus required>
                    <input class="w-full mt-2" type="text" id="productName" name="category" value="{{ old('category', $category->category) }}" placeholder="Enter product name" autofocus required>
                    <input class="w-full" type="hidden" name="slag" id="slag" value="{{ old('slag', $category->slag) }}" required>
                </div>
                                ...
                                <label for="" class="w-full">
                                    ...
                                    <div class="text-center">
                                        <div style="position: relative">
                                            <div class="main-img">
                                            <img src="{{ asset('images/products/categories') }}/{{ $category->poster }}" id="output" alt="photo" style="max-width: 100%; max-height: 100%">
                                            </div>
                                            <div>
                            ...
                            <div class="mt-4 pdt-sides pt-0 px-0 py-1 border border-transparent">
                                ...
                                <div class="d-flex justify-content-between gap-1">
                                    <div class="pdt-side-imgs d-flex justify-content-center">
                                        <div style="position: relative; ">
                                            <img src="{{ asset('images/products/categories') }}/{{ $category->banner }}" alt="photo" id="output1">
                                            <div>
