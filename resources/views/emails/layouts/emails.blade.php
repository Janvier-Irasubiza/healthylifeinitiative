...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Healthy Life - @yield('title')</title>
        ...
        <div class="content text-center">
            ...
            <div class="">
                <div class="mb-4" style="">
                    <h4 style="font-size: 23px"><strong>Healthy Life Initiative Ltd</strong></h4>
                </div>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <div class="mt-3">
                    ...
                    © {{ date('Y') }} <strong>More Steps Ahead Ltd</strong>. @lang('All rights reserved.')
